...
<style>
    ...
    /* DESKTOP COLLAPSE (Full hide when collapsed) */
    @media (min-width: 992px) {
        /* Collapsed = fully hidden (no icons) */
        .admin-shared-sidebar .sidebar.collapsed {
    ...
    /* Layout sizing: main should adapt when sidebar is present or collapsed */
    #main {
...
<div class="admin-shared-sidebar">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <!-- Desktop toggle moved to page header -->
        </div>
...
<script src="../assets/js/admin_shared.js" defer></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
<script>
function confirmLogout() {
    const logoutModal = new bootstrap.Modal(document.getElementById('logoutModal'), { backdrop: false });
    logoutModal.show();
}
</script>
