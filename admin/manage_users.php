...
<div class="modal fade" id="qrModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered modal-lg"> <!-- bigger dialog -->
    <div class="modal-content text-center p-4" style="max-width: 500px; margin: auto;">
      <div class="modal-header border-0 pb-0">
        <h6 id="qrName" class="fw-bold mb-0"></h6>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body pt-2">
        <img id="qrImg" src="" class="img-fluid rounded shadow-sm" style="width: 200px; max-width: 100%; height: auto;">
      </div>
    </div>
  </div>
</div>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <?= csrf_script(); ?>
<script>
    const uM = new bootstrap.Modal('#userModal');
    const qM = new bootstrap.Modal('#qrModal', { backdrop: false });

    // make sure modals are hidden and remove any leftover backdrops when the page loads
    document.addEventListener('DOMContentLoaded', () => {
        ['#userModal', '#qrModal'].forEach(id => {
