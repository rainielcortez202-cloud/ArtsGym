    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow" style="border-radius: 16px;">
            <div class="modal-header border-0 pb-2">
                <h5 class="modal-title fw-bold"><i class=""></i>Change Daily Rate</h5>
...
<script>
    // initialize modal with no backdrop so background controls remain clickable
    const rateModal = new bootstrap.Modal(document.getElementById('rateModal'), { backdrop: false });

    // ensure the modal is completely hidden on load (no lingering "show" state) and remove any stray backdrops
    ...
    // when the modal hides, reset the input
    document.getElementById('rateModal').addEventListener('hidden.bs.modal', () => {
