...
<body class="<?= isset($_COOKIE['theme']) && $_COOKIE['theme'] == 'dark' ? 'dark-mode-active' : '' ?>">
    ...
    <!-- Sidebar overlay for consistent toggle behavior (matches dashboard) -->
    <div class="sidebar-overlay" id="sidebarOverlay" onclick="toggleSidebar()"></div>
    <?php include __DIR__ . '/_sidebar.php'; ?>

    <div id="main">
        <!-- Top Navbar (aligned with dashboard layout) -->
        <header class="top-header">
            <div class="header-title d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0 d-none d-sm-block">Generated reports and stats</p>
                </div>
            </div>
