...
<head>
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            ...
            /* Make stats 2 columns on mobile */
...
<body class="<?= isset($_COOKIE['theme']) && $_COOKIE['theme'] == 'dark' ? 'dark-mode-active' : '' ?>">
    ...
    <div id="main">
        <header class="top-header">
            <div class="header-title d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0 d-none d-sm-block">Staff Dashboard</p>
                </div>
            </div>
        ...
        <!-- Stats Grid: 2 cols on mobile, 2 on tablet, 4 on desktop -->
        <div class="row row-cols-2 row-cols-md-2 row-cols-xl-4 g-3 mb-4 row-cols-mobile-2">
            <div class="col">
                <div class="card-box">
            ...
            <div class="col">
                <div class="card-box">
                    ...
                    <div class="stat-value"><?= $daily_walkins_count; ?></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-xl-6">
                <div class="table-card">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <a href="attendance_register.php" class="small fw-bold text-decoration-none">View All</a>
                    </div>
                        ...
                        <table class="table table-sm align-middle mb-0">
                            ...
                            <tbody>
                                <?php if(count($recent_attendance) > 0): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr><td colspan="2" class="text-center text-muted py-4 small">No attendance recorded today.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-sm align-middle mb-0">
                            ...
                            <tbody>
                                <?php if(count($recent_walkins) > 0): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr><td colspan="2" class="text-center text-muted py-4 small">No walk-ins registered today.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
